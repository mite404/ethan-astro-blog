...
between a **390px** and a **1280px** viewport, so sizes move smoothly _through_ both breakpoints.
...
body[data-layout-type='portfolio'] {
  ...
  --gutter: clamp(1rem, 0.55rem + 1.8vw, 2rem); /*  16 →  32 */
  ...
  --space-bio: clamp(3.75rem, 0.63rem + 12.8vw, 10.875rem); /*  60 → 174 */
